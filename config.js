...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "B.m.b-Xmd~haVEAAIK#zpGi8KEVjplOWOj3xYfCmcJZ4KXmMES9ietYsaqQLWo",
// add your Session Id 
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot
BOT_NAME: process.env.BOT_NAME || "✦ A.W.S-XMD ✦ XMD ✦",
...
OWNER_NAME: process.env.OWNER_NAME || "✦ A.W.S-XMD ✦ XMD ✦",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ✦ A.W.S-XMD ✦ XMD ✦*",
// add bot owner name    
